            ...
            <form id="edit-form" action="{{ route('user-update' , ['username' =>$user->username]) }}" method="post">
                ...
                <div class="user-profile-picture-and-header-info">
                    ...
                    <div class="user-header-info">
                        <div class="media-body">
                            ...
                            <br>
                            <p>Full Name</p>
                            <p class="user-fullname"><input name="full-name" class="textbox" type="text" value="{{$user->full_name}}" maxlength="100"></p>
                            <br>
                            <p>Status</p>
                            <p class="user-status">
                ...
                <div class="user-description">
                    ...
                    <div class="user-location">
                        <p>Location</p>
                        <p><input name="location" class="textbox" type="text" value="{{$user->location}}" maxlength="100"></p>
                    </div>
                    <div class="save-btn">
